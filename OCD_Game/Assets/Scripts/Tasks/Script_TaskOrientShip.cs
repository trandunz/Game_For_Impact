...
public class Script_TaskOrientShip : MonoBehaviour
{
    ...
    private void OnEnable()
    {
        ...
        destination.rectTransform.position = new Vector3(ShipStartPos.x + Random.Range(-200, 200), destination.rectTransform.position.y, destination.rectTransform.position.z);
        canSteer = true;
    }
